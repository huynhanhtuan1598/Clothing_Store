    ...
    return (
        <>
            <div id="content-wrapper" className="d-flex flex-column">
                <div id="content">
                    ...
                    <div className="container-fluid">
                        {/* Page Heading */}
                        <h1 className="h3 mb-2 text-gray-800">Account Management</h1>
                        {/* DataTales Example */}
                        <div className="card shadow mb-4">
                            <div className="card-header py-3" style={{ marginBottom: "5px" }}>
                                <h6 className="m-0 font-weight-bold text-primary" style={{ display: "flex", justifyContent: "space-between" }}>
                                    ...
                                    <Button variant="success" onClick={handleShow} style={{ top: "15px", right: "10px" }}>Add Account</Button>
                                </h6>
                            </div>
                        ...
                        {({
                            ...
                            <Form onSubmit={handleSubmit} style={{ color: "black", fontSize: "18px" }}>
                                <Row>
                                    ...
                                    <Col>
                                        <Form.Label>Account Rights</Form.Label>
                                ...
                                <Button type="submit" variant='success' style={{ marginTop: "15px", float: "right" }} >Create</Button>
                            </Form>
                        )}
                    </Formik>
                </Modal.Body >
                ...
                <Modal.Body>
                    <Formik
                        onSubmit={values => {
                            ...
                            if (checkPhone === true && checkEmail === true && checkId === true) {
                                if (window.confirm("Edit User Information ?") === true) {
                    ...
                    >
                        {({
                            ...
                            <Form onSubmit={handleSubmit} style={{ color: "black", fontSize: "18px" }}>
                                ...
                                <Button type="button" variant='warning' onClick={() => { setShow1(false); handleShow2(`${idUser}`) }} style={{ marginTop: "15px", color: "black" }} >Password Reset</Button>
            ...
            <Modal show={show2} onHide={handleClose2} size={'xl'} fullscreen={true}>
                ...
                <Modal.Footer>
                    <Button variant="secondary" onClick={handleClose2}>Cancel</Button>
                </Modal.Footer>
            </Modal >
        </>
    )
