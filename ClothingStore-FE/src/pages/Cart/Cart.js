...
export default function Cart() {
    ...
    const handleNumber = async (maCT, calc) => {
        ...
        axios({
            ...
            console.log("Error getting Product Quantity :", err)
        })
    }
    ...
    const handleClick = () => {
        cart.forEach(item => {
            axios({
                ...
                if (data.data[0][0].soLuongTon < item.SL) {
                    alert(`Product ${item.tenSP} Only ${data.data[0][0].soLuongTon}`)
                    dispatch({
                        type: 'DELETE_CART',
        ...
        if (cart.length < 1) {
            alert("Shopping Cart No Products.\nMust Have At least 1 New Payable Product!!!!")
        } else {
            navigate('/checkout')
        }
    }
    ...
    const deleteItemCart = (maCT) => {
        if (window.confirm("Remove Product From Cart ?") === true) {
            dispatch({
                type: 'DELETE_CART',
                payload: { maCT }
            })
                ...
                <div className="container-fluid">
                    <div className="row px-xl-5">
                        ...
                        <div className="col-lg-4">
                            ...
                            <h5 className="section-title position-relative text-uppercase mb-3"><span className="bg-secondary pr-3">Total Shopping Cart</span></h5>
                            <div className="bg-light p-30 mb-5">
                                <div className="border-bottom pb-2">
                                    ...
                                    <div className="d-flex justify-content-between">
                                        <h6 className="font-weight-medium">Delivery charges: </h6>
                                ...
                                <div className="pt-2">
                                    ...
                                    <button onClick={() => handleClick()} className="btn btn-block btn-success font-weight-bold my-3 py-3">Order now</button>
                                </div>
                            </div>
                        </div>
                    </div>
