...
export default function ShopDetails() {
    ...
    const notify = () => { return toast(`Add to cart successfully !!!`) };
    ...
    const handleNumber = (boolean) => {
        if (boolean) {
            ...
            if (num <= 1) {
                alert("Product Quantity Not Less Than 1")
            } else {
                setNum(num - 1)
            }
        }
                        ...
                        <div className="col-lg-7 h-auto mb-30">
                            <div className="h-100 bg-light p-30">
                                ...
                                <div className="d-flex mb-3">
                                    <small className="pt-1" style={{ fontSize: "15px" }}>View: {productID?.luotXem + 1}</small>
                                </div>
                                ...
                                <strong className="text-dark mr-3" >Inventory: {productID?.["SLSize" + radioValue]}</strong>
                                <div className="d-flex align-items-center mb-4 pt-2" style={{ marginTop: "15px" }}>
                                    ...
                                    <button onClick={() => addCart(`${productID?.["SLSize" + radioValue]}`)} className="btn btn-primary px-3"><i className="fa fa-shopping-cart mr-1" />Add to cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
