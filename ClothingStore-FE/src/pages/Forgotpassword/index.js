                            ...
                            <div className="">
                                <div className="p-5">
                                    <div className="text-center">
                                        <h1 className="h4 text-gray-900 mb-4">Password retrieval!</h1>
                                    </div>
                                    <Formik
                                        onSubmit={values => {
                                            axios({
                                    ...
                                    >
                                        {({
                                            ...
                                            <Form onSubmit={handleSubmit} style={{ color: "black", fontSize: "18px" }}>
                                                ...
                                                <Button type="submit" variant='success' style={{ marginTop: "15px", float: "right" }} >Check information</Button>
                                            </Form>
                                        )}
                                    </Formik>
                                    <hr />
                                    <div style={{ paddingTop: "50px" }}>
                                        <div className="text-center">
                                            <NavLink className="small" to='/login'>Forgot password ?</NavLink>
                                        </div>
                                        <div className="text-center">
